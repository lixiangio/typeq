...
export default {
  /** 添加前置中间件 */
  before(func: Middleware) { before.push(func); },
  /** 添加 insert 中间件 */
  insert(func: Middleware) { insert.push(func); },
  /** 添加 select 中间件 */
  find(func: Middleware) { find.push(func); },
  /** 添加 update 中间件 */
  update(func: Middleware) { update.push(func); },
  /** 添加 delete 中间件 */
  delete(func: Middleware) { del.push(func); },
  /** 添加原生 SQL 中间件 */
  query(func: Middleware) { query.push(func); },
  /** 添加后置中间件 */
  after(func: Middleware) { after.push(func); },
  /** 添加插件 */
